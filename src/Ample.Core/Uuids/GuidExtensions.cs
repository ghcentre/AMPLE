...
{
    /// <summary>
    /// Provides extension methods to convert the <see cref="Guid"/> struct to its compact (BASE64)
    /// or Crockford's BASE32 representation.
    /// </summary>
    /// <param name="guid">The GUID instance.</param>
    extension(in Guid guid)
    {
        /// <summary>
        ...
        /// </list>
        /// <para>See <see cref="ParseCompact(in ReadOnlySpan{char})"/> to convert the compact GUID representation
        ...
        /// </code>
        /// <seealso cref="ParseCompact(in ReadOnlySpan{char})"></seealso>
        /// </example>
