...
public class InspectionChunk_Tests
{
    ...
    {
        Should.Throw<ArgumentException>(() => new InspectionChunk(Direction.ClientToServer, null!));
    }

    [Fact]
    public void Ctor_Data0_Throws()
    {
        Should.Throw<ArgumentException>(() => new InspectionChunk(Direction.ClientToServer, []));
    }
    ...
    public void SetLength_Negative_Throws()
    {
        ...
        var sut = new InspectionChunk(Direction.ServerToClient, data);
